// This program prints the standard C++ language standard your compiler is currently using
...
int main() {
  ...
  for (int i = 0; i < numStandards; ++i) {
    if (standard == stdCode[i]) {
      std::cout << "Your compiler is using " << stdName[i] << ", standard code: " << standard << "L\n";
      break;
    }
    if (standard < stdCode[i]){
